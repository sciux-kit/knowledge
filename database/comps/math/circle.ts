...
circle.attr("radius", "The radius of the circle", "number")
...
edgePoint.attr("value", "The decision radian of the position of the point, for example, if radian === 90, the point will be on the bottom of the circle, the default radian direction is clockwise.", "number")
...
circle.withComp(edgePoint, origin)
